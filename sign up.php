...
<div class="sidenav">
         <div class="login-main-text">
			<div class="h-header">
				<img src="Image/hahalolo.png" alt="">
				<h3>Hahalolo</h3>
			</div>	
        </div>
			...
			<div class=" card-text">
				<form>
					...
					By clicking Sign Up, you agree to our?
						<a href="# "> Terms of Service, Data Policy, Cookies Policy</a> <div class="signup1">and</div> <a href="#">Community Standards</a>
					</div>
				</form>
			</div>
		</div>
...
<div class="div_right">
    <div class="language">
	<nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb" class="foot">
  <ol class="breadcrumb">
    <li class="breadcrumb-item " ><a href="#">English</a></li>
    <li class="breadcrumb-item active " aria-current="page">Deutsch</li>
	<li class="breadcrumb-item active" aria-current="page">Tiếng Việt</li>
	<li class="breadcrumb-item active" aria-current="page">中文 (简体)</li>
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><g data-name="Group 28560" fill="none"><path data-name="Rectangle 4657" d="M0 0h24v24H0z"></path><g data-name="Group 28606" stroke="currentColor"><g data-name="Ellipse 989" transform="translate(3 3)"><circle cx="9" cy="9" r="9" stroke="none"></circle><circle cx="9" cy="9" r="8.5"></circle></g><g data-name="Group 28559" stroke-linecap="round" stroke-linejoin="round"><path data-name="Line 36" d="M12.5 8v8.382"></path><path data-name="Line 37" d="M17 12H8"></path></g></g></g></svg>
 </ol>
     </nav>
	</div>
 </div>
